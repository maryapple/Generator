function generate_case(){
    ...
    switch (n1) {
        ...
        case 3:
            ...
            "Отрицательная черта твоего характера",
    ...
    switch (n1) {
        case 0:
            ...
            expl = maketable(t1a[0] + t1a[1] + t1a[2], t5a, t4a[0] + t4a[1], t3a, t2a[0] + t2a[1], t0a, 
                             "первые 3 символа - это первые буквы из вопроса о цвете радуги", "номер дома", 
                             "2 символа от любимого стиля музыки", "спец.символ", 
                             "2 символа от шк предмета", "цифра телефона");
            break; 
        case 1:
            password = t3a[0] + t3a[1] + t5a + t4a[0] + t4a[1] + t4a[2] + t1a[0] + t1a[1] + t0a[0] + t0a[1];
            expl = "</br> + первые 2 символа - район проживания, смайлик, 3 символа - слово с ошибкой, 2 символа - растение, 2 вида - спорт";
            break;
        case 2:
            password = t1a[0] + t1a[1] + t0a + t3a[0] + t3a[1] + t3[2] + t5a + t2a[0] + t2a[1] + t4a[0] + t4a[1];
            expl = "</br> + 2 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 3:
            password = t4a[0] + t4a[1] + t0a + t1a[0] + t1a[1] + t1a[2] + t5a + t3a[0] + t3a[1] + t2a[0];
            expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 4:
         ...
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 5:
            password = t0a[0] + t0a[1] + t0a[2] + t1a + t3a[0] + t3a[1] + t4a[0] + t4a[1] + t5a[0] + t5a[1] + t5a[2];
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 6:
         ...
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 7:
            password = t5a[0] + t5a[1] + t0a + t3a[0] + t3a[1] + t1a + t2a[0] + t2a[1] + t2a[2];
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 8:
         ...
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
        case 9:
            password = t0a[0] + t0a[1] + t4a + t5a[0] + t5a[1]+ t1a[0] + t1a[1] + t3a[0] + t3a[1] + t4a[0];
         expl = "</br> + 1 символ - это первая буква из вопроса о цвете радуги, 2 символ - ";
            break;
    }
